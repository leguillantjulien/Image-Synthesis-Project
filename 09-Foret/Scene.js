...
class Scene
{
    ...
    constructor()
    {
        ...
        this.m_BbArbre2 = new Billboard(this.m_TxArbre1, vec3.fromValues(1.0, 0.0, 3.0),  3.0, 2.0);
        this.m_BbArbre3 = new Billboard(this.m_TxArbre1, vec3.fromValues(1.0, 0.0, 4.0),  3.0, 2.0);
        this.m_BbArbre4 = new Billboard(this.m_TxArbre1, vec3.fromValues(2.0, 0.0, 1.0),  3.0, 2.0);
        this.m_BbArbre5 = new Billboard(this.m_TxArbre1, vec3.fromValues(1.0, 0.0, 2.0),  3.0, 2.0);
        this.m_BbArbre6 = new Billboard(this.m_TxArbre1, vec3.fromValues(3.0, 0.0, 5.0),  3.0, 2.0);
        this.m_BbArbre7 = new Billboard(this.m_TxArbre1, vec3.fromValues(2.0, 0.0, 0.0),  3.0, 2.0);
        this.m_BbArbre8 = new Billboard(this.m_TxArbre1, vec3.fromValues(1.0, 0.0, 2.0),  3.0, 2.0);
...
//        this.m_BbChiffre.onDrawSimple(this.m_MatP, this.m_MatV);
        ...
        this.m_BbArbre1.onDraw(this.m_MatP, this.m_MatV);
 		...
 		this.m_BbArbre2.setModelView(this.m_MatV);
        this.m_BbArbre2.onDraw(this.m_MatP, this.m_MatV);

 		this.m_BbArbre3.setModelView(this.m_MatV);
        this.m_BbArbre3.onDraw(this.m_MatP, this.m_MatV);

        this.m_BbArbre4.setModelView(this.m_MatV);
        this.m_BbArbre4.onDraw(this.m_MatP, this.m_MatV);

        this.m_BbArbre5.setModelView(this.m_MatV);
        this.m_BbArbre5.onDraw(this.m_MatP, this.m_MatV);

        this.m_BbArbre5.setModelView(this.m_MatV);
        this.m_BbArbre5.onDraw(this.m_MatP, this.m_MatV);

        this.m_BbArbre6.setModelView(this.m_MatV);
        this.m_BbArbre6.onDraw(this.m_MatP, this.m_MatV);

        this.m_BbArbre7.setModelView(this.m_MatV);
        this.m_BbArbre7.onDraw(this.m_MatP, this.m_MatV);

        this.m_BbArbre8.setModelView(this.m_MatV);
        this.m_BbArbre8.onDraw(this.m_MatP, this.m_MatV);
