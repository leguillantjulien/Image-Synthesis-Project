...
class Rectangle extends Mesh
{
    ...
    constructor()
    {
        ...
        let matrectangle = new MaterialRectangle();
        ...
        // ajout des sommets
        let P1 = new Vertex(this, -1.0,  0.0,  +1.0).setTexCoords(0.0, 0.0);
        let P2 = new Vertex(this, +1.0,  0.0,  +1.0).setTexCoords(1.0, 0.0);
        let P3 = new Vertex(this, +1.0, +1.0,  -1.0).setTexCoords(1.0, 1.0);
        let P4 = new Vertex(this, -1.0, +1.0,  -1.0).setTexCoords(0.0, 1.0);
